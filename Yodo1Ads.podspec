...
#  ################# 统计 ##################
    s.subspec 'Analytics_AppsFlyer' do |ss|
        ...
        ss.dependency 'AnalyticsAppsFlyer','6.0.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'IronSourceAdQualitySDK','6.2.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
 ...
 ################# YD1 广告 ##############
    ...
    s.subspec 'YD1_IronSource' do |ss|
        ...
        ss.dependency 'YD1IronSource','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_IronSource' do |ss|
        ...
        ss.dependency 'AdmobIronSource','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Vungle' do |ss|
        ...
        ss.dependency 'AdmobVungle','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
   ...
   s.subspec 'Admob_AdColony' do |ss|
        ...
        ss.dependency 'AdmobAdColony','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_MyTarget' do |ss|
        ...
        ss.dependency 'AdmobMyTarget','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Facebook' do |ss|
        ...
        ss.dependency 'ApplovinMaxFacebook','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Admob' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdmob','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_IronSource' do |ss|
        ...
        ss.dependency 'ApplovinMaxIronSource','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Vungle' do |ss|
        ...
        ss.dependency 'ApplovinMaxVungle','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Yandex' do |ss|
        ...
        ss.dependency 'ApplovinMaxYandex','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Fyber' do |ss|
        ...
        ss.dependency 'ApplovinMaxFyber','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ######## YD1Topon ########
    ...
    s.subspec 'IS_Facebook' do |ss|
        ...
        ss.dependency 'ISFacebook','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_UnityAds' do |ss|
        ...
        ss.dependency 'ISUnityAds','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_AppLovin' do |ss|
        ...
        ss.dependency 'ISAppLovin','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_Chartboost' do |ss|
        ...
        ss.dependency 'ISChartboost','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_AdColony' do |ss|
        ...
        ss.dependency 'ISAdColony','6.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_MyTarget' do |ss|
        ...
        ss.dependency 'ISMyTarget','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
