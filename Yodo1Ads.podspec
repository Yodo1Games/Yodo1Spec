Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Ads' do |ss|
        ...
        ss.dependency 'Yodo1AdvertSDK','5.0.1'
    ...
    s.subspec 'Yodo1_UCenter' do |ss|
        ...
        ss.dependency 'Yodo1UCenter','5.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
...
#  ################# 统计 ##################
    s.subspec 'Analytics_AppsFlyer' do |ss|
        ...
        ss.dependency 'AnalyticsAppsFlyer','5.0.4'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_TalkingData' do |ss|
        ...
        ss.dependency 'AnalyticsTalkingData','5.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Umeng' do |ss|
        ...
        ss.dependency 'AnalyticsUmeng','5.0.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Swrve' do |ss|
        ...
        ss.dependency 'AnalyticsSwrve','5.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'Soomla-SDK-Agent','5.21.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
 ...
 ################# YD1 广告 ##############
   ...
   s.subspec 'Admob_AdColony' do |ss|
    ...
    s.subspec 'ApplovinMax_Admob' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdmob','5.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_GDT' do |ss|
        ...
        ss.dependency 'ApplovinMaxGDT','5.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_AppLovin' do |ss|
        ...
        ss.dependency 'ISAppLovin','5.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
