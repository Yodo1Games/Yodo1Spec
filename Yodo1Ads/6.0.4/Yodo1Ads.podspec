...
#  ################# 统计 ##################
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'IronSourceAdQualitySDK','6.4.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
 ...
 ################# YD1 广告 ##############
    ...
    s.subspec 'YD1_Chartboost' do |ss|
        ...
        ss.dependency 'YD1Chartboost','6.0.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Facebook' do |ss|
        ...
        ss.dependency 'AdmobFacebook','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Chartboost' do |ss|
        ...
        ss.dependency 'AdmobChartboost','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
   ...
   s.subspec 'Admob_AdColony' do |ss|
    ...
    s.subspec 'Admob_MyTarget' do |ss|
        ...
        ss.dependency 'AdmobMyTarget','6.0.3'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Pangle' do |ss|
        ...
        ss.dependency 'ApplovinMaxPangle','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Chartboost' do |ss|
        ...
        ss.dependency 'ApplovinMaxChartboost','6.0.2'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_GDT' do |ss|
        ...
        ss.dependency 'ApplovinMaxGDT','6.0.3'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'IS_Chartboost' do |ss|
        ...
        ss.dependency 'ISChartboost','6.0.3'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
