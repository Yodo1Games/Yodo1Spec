Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Ads' do |ss|
        ...
        ss.dependency 'OpenSuitThirdsAnalytics', '1.0.3'
    end
    ...
    s.subspec 'Yodo1_UCenter' do |ss|
        ...
        ss.dependency 'OpenSuitPayment','1.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
...
#  ################# 统计 ##################
    ...
    s.subspec 'OpenSuit_AnalyticsAppsFlyer' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsAppsFlyer','1.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsFirebase' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsFirebase','1.0.3'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsSwrve' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsSwrve','1.0.4'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'OpenSuit_AnalyticsTalkingData' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsTalkingData','1.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsUmeng' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsUmeng','1.0.3'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
