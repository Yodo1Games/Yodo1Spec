Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Ads' do |ss|
        ...
        ss.dependency 'OpenSuitThirdsAnalytics', '1.0.4'
    end
    ...
    s.subspec 'Yodo1_UCenter' do |ss|
        ...
        #ss.dependency 'OpenSuitPayment','1.0.8'
        ss.dependency 'Yodo1UCenter','6.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
...
#  ################# 统计 ##################
    s.subspec 'Analytics_AppsFlyer' do |ss|
        ...
        ss.dependency 'AnalyticsAppsFlyer','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    #         "VALID_ARCHS[sdk=iphonesimulator*]": "x86_64"
    #     }
    #     ss.dependency 'AnalyticsTalkingData','6.0.5'
    #     ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    # end
    ...
    s.subspec 'Analytics_Umeng' do |ss|
        ...
        ss.dependency 'AnalyticsUmeng','6.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Swrve' do |ss|
        ...
        ss.dependency 'AnalyticsSwrve','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Firebase' do |ss|
        ...
        ss.dependency 'AnalyticsFirebase','6.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'IronSourceAdQualitySDK','6.8.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    #================OpenSuit Anaylitic============================
    s.subspec 'OpenSuit_AnalyticsAppsFlyer' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsAppsFlyer','1.1.1'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsFirebase' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsFirebase','1.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsSwrve' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsSwrve','1.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'OpenSuit_AnalyticsTalkingData' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsTalkingData','1.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'OpenSuit_AnalyticsUmeng' do |ss|
        ...
        ss.dependency 'OpenSuitAnalyticsUmeng','1.0.4'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
 ...
 ################# YD1 广告 ##############
    ...
    s.subspec 'YD1_Applovin' do |ss|
        ...
        ss.dependency 'YD1Applovin','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_UnityAds' do |ss|
        ...
        ss.dependency 'YD1UnityAds','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Facebook' do |ss|
        ...
        ss.dependency 'YD1Facebook','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_ApplovinMax' do |ss|
        ...
        ss.dependency 'YD1ApplovinMax','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Chartboost' do |ss|
        ...
        ss.dependency 'YD1Chartboost','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_AdColony' do |ss|
        ...
        ss.dependency 'YD1AdColony','6.0.5'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'YD1_MyTarget' do |ss|
        ...
        ss.dependency 'YD1MyTarget','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Facebook' do |ss|
        ...
        ss.dependency 'AdmobFacebook','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Tapjoy' do |ss|
        ...
        ss.dependency 'AdmobTapjoy','6.0.6'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'Admob_Vungle' do |ss|
        ...
        ss.dependency 'AdmobVungle','6.1.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Inmobi' do |ss|
        ...
        ss.dependency 'AdmobInmobi','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_UnityAds' do |ss|
        ...
        ss.dependency 'AdmobUnityAds','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Chartboost' do |ss|
        ...
        ss.dependency 'AdmobChartboost','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_AppLovin' do |ss|
        ...
        ss.dependency 'AdmobAppLovin','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
   ...
   s.subspec 'Admob_AdColony' do |ss|
        ...
        ss.dependency 'AdmobAdColony','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'Admob_MyTarget' do |ss|
        ...
        ss.dependency 'AdmobMyTarget','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Facebook' do |ss|
        ...
        ss.dependency 'ApplovinMaxFacebook','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Admob' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdmob','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Inmobi' do |ss|
        ...
        ss.dependency 'ApplovinMaxInmobi','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_IronSource' do |ss|
        ...
        ss.dependency 'ApplovinMaxIronSource','6.1.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Tapjoy' do |ss|
        ...
        ss.dependency 'ApplovinMaxTapjoy','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'ApplovinMax_UnityAds' do |ss|
        ...
        ss.dependency 'ApplovinMaxUnityAds','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    s.subspec 'ApplovinMax_Vungle' do |ss|
        ...
        ss.dependency 'ApplovinMaxVungle','6.1.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Pangle' do |ss|
        ...
        ss.dependency 'ApplovinMaxPangle','6.0.9'
    ...
    s.subspec 'ApplovinMax_Chartboost' do |ss|
        ...
        ss.dependency 'ApplovinMaxChartboost','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_AdColony' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdColony','6.0.7'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_MyTarget' do |ss|
        ...
        ss.dependency 'ApplovinMaxMyTarget','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Yandex' do |ss|
        ...
        ss.dependency 'ApplovinMaxYandex','6.0.8'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_GDT' do |ss|
        ...
        ss.dependency 'ApplovinMaxGDT','6.1.0'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Fyber' do |ss|
        ...
        ss.dependency 'ApplovinMaxFyber','6.0.9'
        ss.dependency 'Yodo1Ads/Yodo1_Ads',"#{s.version}"
    end
    ######## YD1Topon ########
