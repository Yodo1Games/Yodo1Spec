Pod::Spec.new do |s|
    ...
    s.subspec 'Yodo1_Manager' do |ss|
        ...
        ss.dependency 'Yodo1ThirdsAnalytics','4.2.4'
    ...
    s.subspec 'Yodo1_Share' do |ss|
        ...
        ss.dependency 'Yodo1Share','4.1.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_iRate' do |ss|
     ...
     s.subspec 'Yodo1_GameCenter' do |ss|
        ...
        ss.dependency 'Yodo1GameCenter','4.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
     s.subspec 'Yodo1_iCloud' do |ss|
        ...
        ss.dependency 'Yodo1iCloud','4.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'Yodo1_Notification' do |ss|
        ...
        ss.dependency 'Yodo1Notification','4.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_Replay' do |ss|
        ...
        ss.dependency 'Yodo1Replay','4.1.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Yodo1_AntiAddiction' do |ss|
        ...
        ss.dependency 'Yodo1AntiAddiction','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    ################# 统计 ##############
     s.subspec 'Analytics_AppsFlyer' do |ss|
        ...
        ss.dependency 'AnalyticsAdapterAppsFlyer','4.2.6'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_TalkingData' do |ss|
        ...
        ss.dependency 'AnalyticsAdapterTalkingData','4.2.5'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Umeng' do |ss|
        ...
        ss.dependency 'AnalyticsAdapterUmeng','4.2.6'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Analytics_Swrve' do |ss|
        ...
        ss.dependency 'AnalyticsAdapterSwrve','4.2.5'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
   ...
   #  ################# YD1 广告 ##############
    ...
    s.subspec 'YD1_Applovin' do |ss|
        ...
        ss.dependency 'YD1Applovin','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_IronSource' do |ss|
        ...
        ss.dependency 'YD1IronSource','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Mintegral' do |ss|
        ...
        ss.dependency 'YD1Mintegral','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_UnityAds' do |ss|
        ...
        ss.dependency 'YD1UnityAds','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Toutiao' do |ss|
        ...
        ss.dependency 'YD1Toutiao','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Facebook' do |ss|
        ...
        ss.dependency 'YD1Facebook','4.1.7'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_ApplovinMax' do |ss|
        ...
        ss.dependency 'YD1ApplovinMax','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Chartboost' do |ss|
        ...
        ss.dependency 'YD1Chartboost','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_AdColony' do |ss|
        ...
        ss.dependency 'YD1AdColony','4.1.7'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_MyTarget' do |ss|
        ...
        ss.dependency 'YD1MyTarget','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Facebook' do |ss|
        ...
        ss.dependency 'AdmobFacebook','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'Admob_IronSource' do |ss|
        ...
        ss.dependency 'AdmobIronSource','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'Admob_Tapjoy' do |ss|
        ...
        ss.dependency 'AdmobTapjoy','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'Admob_Vungle' do |ss|
        ...
        ss.dependency 'AdmobVungle','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Inmobi' do |ss|
        ...
        ss.dependency 'AdmobInmobi','4.1.7'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_UnityAds' do |ss|
        ...
        ss.dependency 'AdmobUnityAds','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_Chartboost' do |ss|
        ...
        ss.dependency 'AdmobChartboost','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_AppLovin' do |ss|
        ...
        ss.dependency 'AdmobAppLovin','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
   ...
   s.subspec 'Admob_AdColony' do |ss|
        ...
        ss.dependency 'AdmobAdColony','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'Admob_MyTarget' do |ss|
        ...
        ss.dependency 'AdmobMyTarget','4.0.2'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Facebook' do |ss|
        ...
        ss.dependency 'ApplovinMaxFacebook','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Admob' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdmob','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Inmobi' do |ss|
        ...
        ss.dependency 'ApplovinMaxInmobi','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_IronSource' do |ss|
        ...
        ss.dependency 'ApplovinMaxIronSource','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'ApplovinMax_Mintegral' do |ss|
        ...
        ss.dependency 'ApplovinMaxMintegral','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Tapjoy' do |ss|
        ...
        ss.dependency 'ApplovinMaxTapjoy','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'ApplovinMax_UnityAds' do |ss|
        ...
        ss.dependency 'ApplovinMaxUnityAds','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'ApplovinMax_Vungle' do |ss|
        ...
        ss.dependency 'ApplovinMaxVungle','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Toutiao' do |ss|
        ...
        ss.dependency 'ApplovinMaxToutiao','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Chartboost' do |ss|
        ...
        ss.dependency 'ApplovinMaxChartboost','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_AdColony' do |ss|
        ...
        ss.dependency 'ApplovinMaxAdColony','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_MyTarget' do |ss|
        ...
        ss.dependency 'ApplovinMaxMyTarget','4.1.9'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Yandex' do |ss|
        ...
        ss.dependency 'ApplovinMaxYandex','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'ApplovinMax_Smaato' do |ss|
        ...
        ss.dependency 'ApplovinMaxSmaato','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_GDT' do |ss|
        ...
        ss.dependency 'ApplovinMaxGDT','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Amazon' do |ss|
        ...
        ss.dependency 'ApplovinMaxAmazon','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Verizon' do |ss|
        ...
        ss.dependency 'ApplovinMaxVerizon','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Fyber' do |ss|
        ...
        ss.dependency 'ApplovinMaxFyber','4.1.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ######## YD1Topon ########
    s.subspec 'AnyThink_Baidu' do |ss|
        ...
        ss.dependency 'AnyThinkBaidu','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'AnyThink_Mintegral' do |ss|
        ...
        ss.dependency 'AnyThinkMintegral','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    s.subspec 'AnyThink_Sigmob' do |ss|
        ...
        ss.dependency 'AnyThinkSigmob','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'AnyThink_UnityAds' do |ss|
        ...
        ss.dependency 'AnyThinkUnityAds','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'AnyThink_GDT' do |ss|
        ...
        ss.dependency 'AnyThinkGDT','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'AnyThink_Admob' do |ss|
        ...
        ss.dependency 'AnyThinkAdmob','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'AnyThink_Vungle' do |ss|
        ...
        ss.dependency 'AnyThinkVungle','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'AnyThink_TouTiao' do |ss|
        ...
        ss.dependency 'AnyThinkTouTiao','4.0.0'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ######## YD1ISource ########
