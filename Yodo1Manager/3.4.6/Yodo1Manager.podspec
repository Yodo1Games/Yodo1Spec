Pod::Spec.new do |s|
    s.name             = 'Yodo1Manager'
    s.version          = '3.4.6'
    s.summary          = 'v3.4.6- 2019-09-25
                            1.更新Soomla v5.0.4 fix bug
                            2.回滚头条v2.2.0.0
                          '
    s.description      = <<-DESC
    ...
    s.subspec 'Yodo1_Soomla' do |ss|
        ...
        ss.dependency 'Yodo1Soomla','3.1.1'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Mintegral' do |ss|
        ...
        ss.dependency 'YD1Mintegral','3.1.6'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'YD1_Toutiao' do |ss|
        ...
        ss.dependency 'YD1Toutiao','3.1.7'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Mintegral' do |ss|
        ...
        ss.dependency 'ApplovinMaxMintegral','3.0.13'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
    ...
    s.subspec 'ApplovinMax_Toutiao' do |ss|
        ...
        ss.dependency 'ApplovinMaxToutiao','3.0.8'
        ss.dependency 'Yodo1Manager/Yodo1_Manager',"#{s.version}"
    end
